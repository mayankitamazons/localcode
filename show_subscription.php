            ...
            <main class="main-wrapper clearfix" style="min-height: 522px;">
                ...
                <div class="row" id="main-content" style="padding-top:25px">
					...
					<div class="well" style="width:100%">
						<h3>List Users for <?php echo $subscription_name ?> 
						...
						<table class="table table-striped">
							...
							?>
								<tr>
									...
									<td><?php echo date('F d, Y', strtotime($key['paid_date'])); ?></td>	
									
									<td><a class="mr-4" href="memberorder.php?user_id=<?php echo $user_id;?>&promo_id=<?php echo $subscription_data['id'] ?>">
