...
<body class="header-light sidebar-dark sidebar-expand pace-done">
                ...
                <div class="row" id="main-content" style="padding-top:25px">
					...
					<div class="well col-md-6">
						<div style="margin:10px">
							<img src="qrcode/qrcode.php?text=<?php echo $user_email; ?>" style="width:100%">
						</div>
						<div style="padding:10px;">
							<h6>Or Send Money to This Address</h6>
							<h3 style="text-align:center;"><?php echo $user_email; ?></h3>
						</div>
					</div>
 ...
 $datetime2 = new DateTime($current_time);
	...
	//~ print_r($interval);
					...
					echo '<p> You have received amount '.$row['amount'].' from ' .$row['name'].'';
					echo '<form id="myform" action="">';
					echo '<input type="hidden" name="id" value="'.$row['id'].'">';
					echo '<button class="button" type="submit" name="submit" value="accept" id="accept" >Accept</button>';
					echo '<button class="button1" type="submit1" name="decline" value="decline" id="decline">Decline</button>';
					echo '</form>';
					echo '<br></p> </form>';
		 }
							}
