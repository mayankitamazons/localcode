...
if(isset($_POST['submit']))
{
	...
	{  
		...
		section_required='$section_required',table_required='$table_required',cash_check='$cash_check',credit_check='$credit_check',wallet_check='$wallet_check',boost_check='$boost_check',grab_check='$grab_check',wechat_check='$wechat_check',touch_check='$touch_check',fpx_check='$fpx_check' WHERE id='".$_SESSION['login']."'";
									...
									<!--div class="form-group">
										 <div class="row justify-content-center" style="margin: 10px 0;">
											...
											<div class="col" style="padding: 0 2px">
											  <input type="time" class="form-control" name="start_time_setup" value="<?php echo $start_time_setup; ?>">
											</div>
											  </div>
											</div>
											<div class="col">
											  ...
											  <div class="row">
												<div class="col" style="padding: 0 2px">
											  <input type="time" class="form-control" name="end_time_setup" value="<?php  echo $end_time_setup;?>">
											</div>
											  </div>
											</div>
										  </div>
