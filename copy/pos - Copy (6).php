  ...
  $( document ).ready(function() {
   ...
   else
   {
    ...
    $("#varient_name").html(name);
      ...
      $(".pop_model").html("<div class='row' style='width:11em'><div class='col-md-12'>Quantity: <input name='quantity_input' type='number' class='quatity' value='1' style='width:2em;text-align:center' min='0' max='99'></div></div><input type='hidden' name='single_ingredients' value='" + single_remarks + "'/><input type='hidden' name='extra' value='" + p_extra + "'/><span id='pop_cart' data-pr=" + p_price + " data-id='"+id+"' data-code='"+code+"'  data-name='"+name+"' data-quantity='"+quantity+"'>Add to Cart</span>");
