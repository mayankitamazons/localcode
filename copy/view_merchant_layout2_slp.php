                ...
                <div class="sub_category_grid">
                    ...
                    foreach ($categories as $category)
                    {
						if($ordercount>0)
						{
							 ...
							 WHERE category.user_id ='".$id."' and category.catparent='".$index."' and category.status=0 order by arrange_system.shift_pos asc";
                ...
                <div class="grid">
					...
					if($pcount>0)
					{
						 $q="SELECT products.*,arrange_system.shift_pos FROM products inner join arrange_system on  products.id=arrange_system.entity_id
							 WHERE products.user_id ='".$id."'  and products.status=0 order by arrange_system.shift_pos asc";
