                            ...
                            <div id="left-bottom">
                                <table id="totalTable"
                                   ...
                                   <!--   <textarea name="payment_note[]" id="payment_note_2" class="pa form-control kb-text" aria-haspopup="true" role="textbox"></textarea>-->
                                           <input class="form-control kb-text " value="<?php if(isset($_GET['t'])){ echo $_GET['t'];} ?>" onclick="display_keyboards()" id="table" name="table" type="Number" />
                                          </div>
                                        </td>
                                      </tr>
  ...
  $( document ).ready(function() {
   ...
   // alert(rmk_val);
    ...
    $.ajax({
      type: 'post',
      url: 'productData.php',
      data: {p_id:id,sp_id:ex_id,remark:remark,extravar:extravar,rmk_val:rmk_val,extra_value:extra_value},
      success: function (data) {
      //alert(data);
      if( data != null ) {
			//alert('The product added');
