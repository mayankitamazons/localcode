...
<body onload="initialize()" class="header-light sidebar-dark sidebar-expand pace-done">
    ...
    <?php } ?>
        ...
        <form method="post" id="order_place">
        <?php
        $stl_key = rand();
        ...
        <?php } else { ?>
        <form id="order_place"  method="post">
        <?php } ?>
  ...
  <div style="float:left;width:100%;top:0;">
    ...
    <div style="float:left;width:33%;">
        ...
        <input type="hidden" name='varient_count' value='0' id='varient_count'/>
            ...
            <input type="text" class="form-control table" id="table_type_order" name="table_type"  <?php if($merchant_detail['table_required']=="1"){ echo "required";} ?>  value="<?php echo $tablenumber; ?>"/>
    ...
    <div>
      <div class="input-group mb-2" style="margin-bottom:0px !important;">
        ...
        <input type="number" autocomplete="tel" maxlength='10' style="max-width:220px;"  class="mobile_number form-control" value="<?php if($check_number){ echo $check_number;}  ?>" placeholder="123115670" name="mobile_number" required="" />
   ...
   <div class="container">
    <div class="row">
        <div class="col-xs-6">
           <input type="submit" style="width:100% !important;" class="btn btn-block btn-primary submit_button" name="submit"  id="confm"  value="<?php echo $language["confirm_order"];?>">
...
<?php } ?>
  ...
  <div class="modal fade" id="OrderModel" role="dialog" style="">
   <div class="modal-dialog">
           <?php 
            ...
            <div class="modal-content">
             ...
             <p style="font-size: 16px;color: red;"><span style='font-size:20px;'>&#128512;</span> Congratulations ! Your order has been sent to our kitchen!
			 <br/> You can Place new order</p>
   ...
   if(go_ahead=="y")
   {
    ...
    var p_extra = $(this).siblings("input[name='extra']").val();
     ...
     $(".element-item input[name='extra']").val('');
      ...
      // alert(varient_type);
      $("#test").append("<tr class='orderitem'> <td><button type='button' class='removebutton'>X</button> </td><td>"+name+"</td><td><input style='width:50px;'  onchange='UpdateTotal("+id+" ,"+p_price+")'  type=number name='qty[]' maxlength='3' class='product_qty'  value="+quantity+" id='"+id+"_test_athy'><input type= hidden name='p_id[]' value= "+id+"><input type= hidden name='p_code[]' value= "+code+"><input type='hidden' name='ingredients' value='" + single_remarks + "'/></td><td>"+code+"</td><td><a href='#remarks_area' role='button' class='introduce-remarks btn btn-large btn-primary' data-toggle='modal'>" + ((single_remarks == '') ? "Remarks" : single_remarks) +  "</a><input type='hidden' name='extra' value='"+extra_price+"'></td><td><input style='width:70px;text-align:right;' type='text' name='p_extra' value='" + extra_price.toFixed(2) + "' readonly></td><td><input style='width:70px;' type='text' name='p_price[]' value='"+p_price+"' readonly></td><td><input type='text' style='width:70px;' name='p_total[]' value= "+ p_total + " readonly  id='"+id+"_cat_total'><input type='hidden' name='varient_type[]' value="+varient_type+"></td> </tr>");
      // alert('The product added');
      $(".quatity").val(1);
...
$('.master_category_filter').on( 'click', function(e) {
  ...
  $(".text_add_cart_without").on("click", function(){
    ...
    $("#test").append("<tr class='orderitem'>  <td><button type='button' class='removebutton'>X</button> </td><td>"+name+"</td><td><input style='width:50px;' maxlength='3'  onchange='UpdateTotal("+id+" ,"+p_price+")'  type=number name='qty[]' class='product_qty' value="+quantity+" id='"+id+"_test_athy'><input type= hidden name='p_id[]' value= "+id+"><input type= hidden name='p_code[]' value= "+code+"><input type='hidden' name='ingredients'/></td><td>"+code+"</td><td><a href='#remarks_area' role='button' class='introduce-remarks btn btn-large btn-primary' data-toggle='modal'>Remarks</a><input type='hidden' name='extra'></td><td><input style='width:70px;text-align:right;' type='text' name='p_extra' value='0' readonly></td>  <td><input style='width:70px;' type='text' name='p_price[]' value= "+p_price+" readonly></td><td><input type='text' style='width:70px;' name='p_total[]' value= "+p_total+" readonly  id='"+id+"_cat_total'></td> </tr>");
    alert('The product added');
  });
  ...
  if(menu_type==2){
    ...
    if(menu_type==1)
    {
      ...
      $(".text_add_cart").on("click", function(){
        ...
        $("#test").append("<tr class='orderitem'>  <td><button type='button' class='removebutton'>X</button> </td><td>"+name+"</td><td><input style='width:50px;'  onchange='UpdateTotal("+id+" ,"+p_price+")'  type=number name='qty[]' class='product_qty' maxlength='3'  value="+quantity+" id='"+id+"_test_athy'><input type= hidden name='p_id[]' value= "+id+"><input type= hidden name='p_code[]' value= "+code+"><input type='hidden' name='ingredients'/></td><td>"+code+"</td><td><a href='#remarks_area' role='button' class='introduce-remarks btn btn-large btn-primary' data-toggle='modal'>Remarks</a><input type='hidden' name='extra' value='" + p_extra + "'></td><td><input style='width:70px;text-align:right;' type='text' name='p_extra' value='0' readonly></td>  <td><input style='width:70px;' type='text' name='p_price[]' value= "+p_price+" readonly></td><td><input type='text' style='width:70px;' name='p_total[]' value= "+p_total+" readonly  id='"+id+"_cat_total'></td> </tr>");
        alert('The product added');
      });
			...
			else
			{
				...
				data: $('form').serialize(),
				  ...
				  var data = JSON.parse(JSON.stringify(res));
					// alert(data);
					$('#table_type_order').val();    
					  $("html, body").animate({ scrollTop: 0 }, "slow");
					if(data.status==true)
					{
						
						$('.orderitem').remove();
						var section_saved=data.section_saved;
						if(section_saved=='n')
						{
