  ...
  <div style="float:left;width:100%;top:0;">
    ...
    <div>
      <div class="input-group mb-2" style="margin-bottom:0px !important;">
        ...
        <input type="number" autocomplete="tel" maxlength='10' style="max-width:220px;"  class="mobile_number form-control" value="<?php if($check_number){ echo $check_number;}  ?>" placeholder="123115670" name="mobile_number" <?php if($merchant_detail['guest_permission']=='0'){ echo "required";} ?> />
...
.well.col-md-4{
  ...
  <?php
		...
		$daysquery=mysqli_query($conn,"SELECT * FROM set_working_hr WHERE merchant_id='".$_SESSION['merchant_id']."'");
		$days_count=mysqli_num_rows($daysquery);
		if($days_count>0)
		{
			$dayss= mysqli_fetch_assoc($daysquery);
...
$(document).ready(function(){
	...
	var days_count=<?php echo $days_count; ?>;
	// alert(days_count);
	days_count=0;
	if(days_count>0)
	{
		...
		// alert(ed);
             ...
             if(($start < $var) &&($end > $var))
              ...
              <?php }else {?>      
				  ...
				  $('#error_label').html("Sorry, we are closed at this time");
              ...
              {
                 $('#error_label').html("Sorry,Shop is Close now");
