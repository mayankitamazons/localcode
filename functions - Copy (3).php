...
if(isset($_POST['method']) && ($_POST['method'] == "productfind")){
	...
	$p_detail = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM products WHERE product_type='".$p_code."' and user_id='".$login."'"));
	if($p_detail)
	{
		$p_detail=array('status'=>true,'msg'=>'Invalid','data'=>$p_detail);
	}
	else
	{
