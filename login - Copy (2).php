...
<html>
                           ...
                           <form class="frmlogin" method="post">
                              <div class="login-top">
                                 ...
                                 <div class="login-bottom login-bottom1">
                                    <div class="submit">
                                       <input type="submit" value="<?php echo $language["login"];?>" name="login" class="submint_login" style="padding:14px;" />
                                       
                                    </div>
                                    
                                    <div style="display: none;" class="btn-wrapper btn-clock-wrapper">
                                        <div style="display: none;text-align: center;" class="alert alert-msg"></div>
                                    	<button type="button" class="btn-clock-in btn btn-outline-success">Clock In</button>
                                        <button type="button" class="btn-clock-out btn btn-outline-danger">Clock Out</button>
                                    </div>
   ...
   <script type="text/javascript">
      ...
      //alert("sdfds");
      					...
      					if($("input[name='user_roleget']:checked").val() == 5)
      					{
							$('.btn-clock-wrapper').show();
						}
      		});
