...
if( isset( $_POST['method']) && ( $_POST['method'] == "normalorder" ) ) {
    ...
    $ref_result = mysqli_fetch_assoc(mysqli_query($conn, "SELECT id,sst_rate print_ip_address,printer_style,printer_profile,usb_name FROM users WHERE id='".$_SESSION['login']."'"));
	// print_R($ref_result);
	// die;
