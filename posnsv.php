                      ...
                      <!--  <div id="left-top">
                       ...
                       <div>
                          ...
                          <div style="clear:both;"></div>
                            ...
                            <div id="left-bottom">
                                <table id="totalTable"
                                       style="width:100%; padding:5px; color:#000; background: #FFF;border: 1px solid red;font-size:22px;">
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        <td class="<?php if($user_roles==2){ echo "show_cal";} ?>" style="padding: 5px 10px; border-top: 1px solid #666; border-bottom: 1px solid #5f5e7d; font-weight:bold; background:#5f5e7d; color:#FFF;" colspan="2">
                                            Payment : (RM)</td>
                                        <td class="text-right" style="padding:5px 10px 5px 10px; font-size: 14px;border-top: 1px solid #666; border-bottom: 1px solid #5f5e7d; font-weight:bold; background:#5f5e7d; color:#FFF;" colspan="2">
                                            <span id="Payment" style="padding:7%;font-size:24px;" class="<?php if($user_roles==2){ echo "show_cal";} ?> btn btn-success btn-block">RM 0.00</span>
                                        </td>
                                    </tr>
                                     <tr>
                                ...
                                <div id="botbuttons" class="col-xs-12 text-center">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6" style="padding: 0;">
                                             <button type="reset" class="btn btn-danger btn-block btn-flat" id="reset" style="height:68px;font-size:24px;">Clear All</button>
                                        </div>
                                        <div class="col-xs-6" style="padding: 0;">
                                            <button type="submit" class="btn btn-success btn-block pos_submit" id="" style="height:68px;font-size:24px;">
