                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th class="product_name test_product"><?php echo $language["product_name"];?></th>
							   <th class="product_name test_product" style="min-width: 350px;"><?php echo "VARIENT";?></th>
                       ...
                       // $user_name = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM users WHERE id ='".$row['user_id']."'"));
                        ...
                        <tr id="<?php echo $row['invoice_no']; ?>" class="<?php echo $todayorder; ?> fdfd <?php echo $callss; ?>" data-id="<?php echo $row['id']; ?>">
                            ...
                            <!--td>
							<a target="_blank" href="<?php echo $site_url; ?>/chat/chat.php?sender=<?php echo $loginidset?>&receiver=<?php echo $row['user_id'];?>"><i class="fa fa-comments-o" style="font-size:25px;"></i></a></td!-->
                                        ...
                                        <div class="col-sm-7" style="float: left;">
                                           ...
                                           <input type="hidden" name="merchant_ses" id="merchant_ses" value="<?php echo $loginidset;?>">
											...
											<div style="padding-top: 5px;    display: flex;">
                                                ...
                                                <input type="text" id="discount3" value="0" class="amount changenumber" name="paid" style="background-color:#6dafe2; font-size: 20px; width: 30%;margin-left: 30%;border: 1px solid #555555 ;padding-left: 4px;">
                                            </div>
