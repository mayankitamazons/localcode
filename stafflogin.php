...
<div id="wrapper" class="wrapper">
    ...
    <div class="content-wrapper">
		...
		<?php 		
					...
					$select="select * from staff_activity_logs where user_id = '$staffid'";
        ...
        <main class="main-wrapper clearfix" style="min-height: 522px;">
			...
			while($row=mysqli_fetch_array($query))
			{
				?>	   
					 <tr>
					   <td><?php echo $i++; ?></td>
					   <td><?php echo  date("M j, Y g:i a",strtotime($row['time_in']))?></td>
					   <td><?php echo  isset($row['time_out'])?date("M j, Y g:i a",strtotime($row['time_out'])):""?></td>
					 </tr>
			<?php } ?>		 
                        </tbody>
                    </table>
