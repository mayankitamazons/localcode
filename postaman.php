...
<div id="wrapper">
    <header id="header" class="navbar">
        <div class="container">
            ...
            <div class="col-xs-6"> 
              	<div class = "col-xs-3">
				  	<a class="btn bblue" style="font-size: 32px;" title="Dashboard" data-placement="bottom" href="dashboard.php">
              	...
              	<div class = "col-sm-3">
				  	<a class="navbar-brand" href="dashboard.php">
					  	<span class="logo">
						  	<span class="pos-logo-lg" style="line-height: 35px;">Koofamilies</span>
                ...
                <div id="pos">
                    ...
                    <div id="leftdiv" class="col-xs-6 col-lg-12 ">
                        ...
                        <div id="print">
                            ...
                            <div style="clear:both;"></div>
                            <div id="left-bottom">
                                <table id="totalTable" style="width:100%; padding:5px; color:#000; background: #FFF;border: 1px solid red;">
                                    <tr>
                                    ...
                                    <tr>
									 ...
									 <tr>
                                        <td class="show_cal" style="padding: 5px 10px; border-top: 1px solid #666; border-bottom: 1px solid #5f5e7d; font-weight:bold; background:#5f5e7d; color:#FFF;" colspan="2">
                                            Payment :</td>
                                        <td class="text-right" style="padding:5px 10px 5px 10px; font-size:32px;border-top: 1px solid #666; border-bottom: 1px solid #5f5e7d; font-weight:bold; background:#5f5e7d; color:#FFF;" colspan="2">
                                            <span id="Payment" style="padding:9%;font-size:25px;" class="show_cal btn btn-success btn-block">RM 0.00</span>
                                        </td>
                                    </tr>
									<tr>
                                ...
                                <div id="botbuttons" class="col-xs-12 text-center">
									...
									<input type="hidden" name="user_id" id="user_id" class="user_id" value="<?php echo $loginidset; ?>"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6" style="padding: 0;">
                                            <button type="submit" class="btn btn-success btn-block" id="" style="height:67px;">
                                                <i class="fa fa-money" style="margin-right: 5px;"></i>Submit 
											</button>
                                        </div>
                                    </div>
                                </div>
					...
					<div class="fixside" id="fixside" style="display:none;">
						<div class="modal-content" style="height:537px !important width:780px;">
							...
							<div class="row">
			  					<div class="col-md-5 input-has-value" style="margin-left:1%;">
                                    ...
                                    <div id="ajaxproducts">
                                        <div class="col-sm-12  text-center" style="padding:0px;">
											...
											<!--div class="col-sm-6 text-center example" >
												...
												<button onclick="run()" class="btn btn-info" style="">Run</button>
											</div!-->
   ...
   var qd=0;
	...
	$(document).on("click",'.without_varient', function(event) {
		...
		$.ajax({
			type: 'post',
			url: 'productData.php',
			data: {p_id:id,sp_id:ex_id,remark:remark,extravar:extravar,rmk_val:rmk_val,last_add_id:last_add_id, qty:qty},
			success: function (data) {
				if( data != null ) {
					$('#check'+id).html('<i class="fa fa-plus"></i>');
