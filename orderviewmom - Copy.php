        ...
        <main class="main-wrapper clearfix" style="min-height: 522px;">
            ...
            <div class="row" id="main-content" style="padding-top:25px">
				...
				<audio id="my_audio" src="<?php echo $site_url;?>/sound.mp3" autostart="0"></audio>    
					  <div data-bfmodal="O2U" class="modal fade right show modal-scrolling" id="" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" data-backdrop="false" style="padding-left: 66%;top:15%;" aria-modal="true">
			  ...
			  <div class="col-md-6">
			   ...
			   <div style="padding-top: 5px;    display: flex;">
                                            ...
                                            <div style="padding-top: 5px;    display: flex;">
                                                ...
                                                <input type="text" id="paid" value="0" class="amount" name="paid" style=" font-size: 20px; width: 30%;margin-left: 30%;border: 1px solid #555555 ;padding-left: 4px;">
                                            </div>
                                            <div style="padding-top: 5px;    display: flex;">
                                                <span style="font-size: 20px; width: 40%;    border: 1px solid;border-bottom-left-radius: 2px; border-top-left-radius: 2px;">Change</span>
                                                <input type="text" id="change" name="change" class="amount" style=" font-size: 20px; width: 30%;margin-left: 30%; border: 1px solid #555555;padding-left: 4px;">
                                            </div>
											<br/>
											<input type="button" class="btn btn-primary btn-md waves-effect waves-light"  value="Submit" onclick="myFunction()">
