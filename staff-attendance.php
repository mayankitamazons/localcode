      ...
      <main class="main-wrapper clearfix" style="min-height: 522px;">
         <div  id="main-content" style="padding-top:25px">
				   <div class="well  col-sm-12">
				     <h3 class="text-center mb-5">STAFF TIME SHEET REPORT</h3>
							...
							<div class="col-sm-4 search-item">
								<div class="form-group input-has-value">
									...
									<select class="form-control" id="staff" name="staff">
										...
										<?php
										   $sql_merchant_staff = "select * from users where parentid='$parentid'";
											$staff_q = mysqli_query($conn,$sql_merchant_staff);
											while ( $staff_row = mysqli_fetch_array($staff_q))
											{ 
												echo '<option value="'.$staff_row['id'].'">'.$staff_row['name'].'('.$staff_row['id'].') - '.$staff_row['mobile_number'].'</option>';
											} 
