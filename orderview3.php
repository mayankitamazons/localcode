		...
		{   
		   ...
		   // print_R($data);
		    ...
		    echo ' <input type="button" style="margin: 10px; background-color:#296ca0;" class="btn btn-info" name="tbl" data-invoce="'.$data['invoice_no'].'" data-id="'.$data['id'].'" data-section="'.$data['section_type'].'"  data-table="'.$data['table_type'].'"  value="'.$show_value.'">';
				     ...
				     <div class="fixside" style="display:none;">
    ...
    <tbody id="pending_data">
			...
			<div class="row">
			  <div class="col-md-6 input-has-value">
			   ...
			   <div style="padding-top: 5px;    display: flex;">
                                                <span style="font-size: 16px; width: 40%;    border: 1px solid;padding-left: 4px; border-bottom-left-radius: 2px; border-top-left-radius: 2px;">Total</span>
                                                <span id="total_qty3" style="font-size: 16px; width: 30%;    border: 1px solid;padding-left: 4px; border-left: none;"></span>
                                                 <input type="hidden" name="tol_qty3" id="tol_qty3" value="">
                                                <span id="total_amount3" style="font-size: 16px;width: 30%;        border: 1px solid;padding-left: 4px; border-left: none; border-bottom-right-radius: 2px; border-top-right-radius: 2px;"></span>
                                                 <input type="hidden" name="tol_mnt3" id="tol_mnt1" value="">
                                            </div>

                                            <div style="padding-top: 5px;    display: flex;" class="input-has-value">
                                                <span style="font-size: 16px; width: 40%;    border: 1px solid; border-bottom-left-radius: 2px; border-top-left-radius: 2px;">Paid</span>
                                            ...
                                            <div style="padding-top: 5px;    display: flex;">
                                                <span style="font-size: 16px; width: 40%;    border: 1px solid;border-bottom-left-radius: 2px; border-top-left-radius: 2px;">Change</span>
                                                <input type="text" id="change3" name="change" class="amount" style=" font-size: 20px; width: 30%;margin-left: 30%; border: 1px solid #555555;padding-left: 4px;">
                                            </div>
											<br>
			  ...
			  <div class="col-md-6">
			    <div class="" style="float: left;">
								...
								<audio id="my_audio" src="<?php echo $site_url;?>/tune.mp3" autostart="0"></audio>  
                <?php if($alaram_required=="y"){ ?>								
