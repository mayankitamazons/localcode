               ...
               <div class="col-md-12">
                  ...
                  <div class="col-md-12 test_test">
                     <div class="col-md-3 test_qwertys">
                        <button class="btn btn-block btn-primary testts fav_list"> Favorite List</button>
                     </div>
                  ...
                  <div class="well col-md-8 test_upload" id="test_upload">
                     ...
                     <div class="common">
                        ...
                        <h3 class="text_mobile">Name: <strong><?php echo $row['name'];?></strong> </h3>
                        <?php
                           }
                           } else {
                  ...
                  <div class="well col-md-8 mer_nam" id="mer_name">
                     ...
                     <form action="structure_merchant.php" method="post">
                        <?php 
                           ...
                           ?>
                        <div>
                           <input type="text"  id="mr_name" autocomplete="off" name="merchant_id" class="form-control" placeholder=" Search By company name"> 
                           <br> 
                  ...
                  <br>
                  <!-- favourate list-->
                  <div class="well col-md-8 favorite_list">
                     <h3> Favorite List</h3>
                     ...
                     <button type="button" class='btn btn-default nearby_restaurant_btn'>Click here to seach nearby shops.</button>
...
<script type="text/javascript" src="<?php echo $site_url; ?>/instascan-master/docs/app.js"></script>
...
<script>
   ...
   document.getElementById('merchant_name').onclick = function() {
       document.getElementById('mr_name').focus();
   };
</script>
<script>
   ...
   $('.tele_num').click(function()
   {   
       $(".test_mobile").toggle();     
   });
   $('.merchant_nam').click(function()
   {   
       $(".mer_nam").toggle();     
   });
